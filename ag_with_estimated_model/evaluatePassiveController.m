...
failures = {{''}
            ...
            {'setRotorStatus(8,''motor loss'',0.78)'}
            {'setRotorStatus(8,''motor loss'',0.001)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(6,''motor loss'',0.78)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(6,''motor loss'',0.001)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(7,''motor loss'',0.78)'}
...
numberOfOptions = length(endTimes)*length(yawGoTos)*size(payloads,1)*length(disturbances)*length(variableCoeffs)*length(failures)*length(controlLoopTimes)
options = cell(numberOfOptions,9);
it = 1;
            ...
            for it4 = 1:length(disturbances)
                for it5 = 1:length(variableCoeffs)
                    for it6 = 1:length(failures)
                        for it7 = 1:length(controlLoopTimes)
                            options(it,1:7) = {endTimes(it1),yawGoTos(it2),payloads(it3,:),disturbances(it4),variableCoeffs(it5),failures{it6},controlLoopTimes(it7)};
                            it = it + 1;
                        end
                    end
                end
...
yawGoTos = [2*pi];
payloads = [0,         0, 0, 0
            0.10*mass, 0, 0, -payloadRadius
            0.20*mass, 0, 0, -payloadRadius
            0.30*mass, 0, 0, -payloadRadius
            0.40*mass, 0, 0, -payloadRadius
            0.50*mass, 0, 0, -payloadRadius
            0.60*mass, 0, 0, -payloadRadius
            0.70*mass, 0, 0, -payloadRadius
            0.80*mass, 0, 0, -payloadRadius
            0.90*mass, 0, 0, -payloadRadius
            mass,      0, 0, -payloadRadius];
disturbances = mass*(0:2.25:45);
controlLoopTimes = 0.020:0.005:0.100;
variableCoeffs = [1,0];
failures = {{''}
            {'setRotorStatus(1,''motor loss'',0.90)'}
            {'setRotorStatus(1,''motor loss'',0.78)'}
            {'setRotorStatus(1,''motor loss'',0.63)'}
            {'setRotorStatus(1,''motor loss'',0.45)'}
            {'setRotorStatus(1,''motor loss'',0.001)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.90)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.78)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.63)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.45)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(3,''motor loss'',0.90)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(3,''motor loss'',0.78)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(3,''motor loss'',0.63)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(3,''motor loss'',0.45)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(3,''motor loss'',0.001)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(3,''motor loss'',0.001)','setRotorStatus(4,''motor loss'',0.90)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(3,''motor loss'',0.001)','setRotorStatus(4,''motor loss'',0.78)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(3,''motor loss'',0.001)','setRotorStatus(4,''motor loss'',0.63)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(3,''motor loss'',0.001)','setRotorStatus(4,''motor loss'',0.45)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(3,''motor loss'',0.001)','setRotorStatus(4,''motor loss'',0.001)'}
            {'setRotorStatus(8,''motor loss'',0.90)'}
            {'setRotorStatus(8,''motor loss'',0.78)'}
            {'setRotorStatus(8,''motor loss'',0.63)'}
            {'setRotorStatus(8,''motor loss'',0.45)'}
            {'setRotorStatus(8,''motor loss'',0.001)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(6,''motor loss'',0.90)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(6,''motor loss'',0.78)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(6,''motor loss'',0.63)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(6,''motor loss'',0.45)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(6,''motor loss'',0.001)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(7,''motor loss'',0.90)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(7,''motor loss'',0.78)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(7,''motor loss'',0.63)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(7,''motor loss'',0.45)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(7,''motor loss'',0.001)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(7,''motor loss'',0.001)','setRotorStatus(8,''motor loss'',0.90)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(7,''motor loss'',0.001)','setRotorStatus(8,''motor loss'',0.78)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(7,''motor loss'',0.001)','setRotorStatus(8,''motor loss'',0.63)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(7,''motor loss'',0.001)','setRotorStatus(8,''motor loss'',0.45)'}
            {'setRotorStatus(1,''motor loss'',0.001)','setRotorStatus(2,''motor loss'',0.001)','setRotorStatus(7,''motor loss'',0.001)','setRotorStatus(8,''motor loss'',0.001)'}};

numberOfOptions = length(endTimes)+size(payloads,1)+length(disturbances)+length(variableCoeffs)+length(failures)+length(controlLoopTimes)
options = cell(numberOfOptions,9);

it = 1;
for jt = 1:length(endTimes)
    options(it,1:7) = {endTimes(jt),bestCase{2},bestCase{3},bestCase{4},bestCase{5},bestCase{6},bestCase{7}};
    it = it + 1;
end
for jt = 1:size(payloads,1)
    options(it,1:7) = {bestCase{1},bestCase{2},payloads(jt,:),bestCase{4},bestCase{5},bestCase{6},bestCase{7}};
    it = it + 1;    
end
for jt = 1:length(disturbances)
    options(it,1:7) = {bestCase{1},bestCase{2},bestCase{3},disturbances(jt),bestCase{5},bestCase{6},bestCase{7}};
    it = it + 1;    
end
for jt = 1:length(variableCoeffs)
    options(it,1:7) = {bestCase{1},bestCase{2},bestCase{3},bestCase{4},variableCoeffs(jt),bestCase{6},bestCase{7}};
    it = it + 1;    
end
for jt = 1:length(failures)
    options(it,1:7) = {bestCase{1},bestCase{2},bestCase{3},bestCase{4},bestCase{5},failures{jt},bestCase{7}};
    it = it + 1;   
end
for jt = 1:length(controlLoopTimes)
    options(it,1:7) = {bestCase{1},bestCase{2},bestCase{3},bestCase{4},bestCase{5},bestCase{6},controlLoopTimes(jt)};
    it = it + 1;
end
